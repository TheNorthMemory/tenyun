...
/** 人脸融合不适宜内容识别人脸信息 */
declare interface FuseFaceReviewDetail {
  /** 保留字段 */
  Field: string;
  /** 人员名称 */
  Label: string;
...
/** 人脸融合不适宜内容识别返回参数item */
declare interface FuseFaceReviewResult {
  /** 保留字段 */
  Category: string;
  /** 状态码， 0为处理成功，其他值为处理失败 */
  Code: string;
...
/** 人脸信息 */
declare interface MaterialFaceList {
  /** 人脸序号 */
  FaceId: string;
  /** 人脸框信息 */
  FaceInfo: FaceInfo;
...
declare interface FaceFusionLiteRequest {
  /** 活动 ID，请在人脸融合控制台查看。 */
  ProjectId: string;
  /** 素材 ID，请在人脸融合控制台查看。 */
  ModelId: string;
...
declare interface FaceFusionLiteResponse {
...
declare interface FaceFusionRequest {
  /** 活动 ID，请在人脸融合控制台查看。 */
  ProjectId: string;
  /** 素材 ID，请在人脸融合控制台查看。 */
  ModelId: string;
...
declare interface FaceFusionResponse {
  /** RspImgType 为 url 时，返回结果的 url， RspImgType 为 base64 时返回 base64 数据。 */
  Image: string;
  /** 不适宜内容识别结果 */
...
export declare type Versions = ["2018-12-01"];
