...
/** 回拨号码字段 */
declare interface CallBackPhoneCode {
  /** 国家码，统一以 00 开头 */
  Nation: string;
...
declare interface RreCallerHandle {
...
/** 直拨话单详情 */
declare interface VirturalNumCdr {
  /** 呼叫通话 ID */
  CallId: string;
...
declare interface CreateCallBackRequest {
  /** 业务appid */
  BizAppId: string;
  ...
  MaxAllowTime?: string;
  /** 主叫发起呼叫状态：1 被叫发起呼叫状态：256 主叫响铃状态：2 被叫响铃状态：512 主叫接听状态：4 被叫接听状态：1024 主叫拒绝接听状态：8 被叫拒绝接听状态：2048 主叫正常挂机状态：16 被叫正常挂机状态：4096 主叫呼叫异常：32 被叫呼叫异常：8192例如：当值为 0：表示所有状态不需要推送；当值为 4：表示只要推送主叫接听状态；当值为 16191：表示所有状态都需要推送(上面所有值和) */
  StatusFlag?: string;
...
declare interface CreateCallBackResponse {
  /** 话单id */
  CallId?: string | null;
  /** 主叫显示系统分配的固话号码 */
...
declare interface DelVirtualNumRequest {
  /** 业务appid */
  BizAppId: string;
  /** 双方号码 + 中间号绑定 ID，该 ID 全局唯一 */
  BindId: string;
...
declare interface DelVirtualNumResponse {
  /** 错误码 */
  ErrorCode?: string;
  /** 错误信息 */
  Msg?: string | null;
...
declare interface DeleteCallBackRequest {
  /** 业务appid */
  BizAppId: string;
  /** 回拨请求响应中返回的 callId */
  CallId: string;
...
declare interface DeleteCallBackResponse {
  /** 错误码 */
  ErrorCode?: string;
  /** 错误原因 */
  Msg?: string | null;
...
declare interface DescribeCallBackCdrRequest {
  /** 业务appid */
  BizAppId: string;
...
declare interface DescribeCallBackCdrResponse {
  /** 话单列表 */
  Cdr?: CallBackCdr[] | null;
  /** 偏移 */
  Offset?: string | null;
  /** 错误码 */
...
declare interface DescribeCallBackStatusRequest {
  /** 业务appid */
  BizAppId: string;
  /** 回拨请求响应中返回的 callId */
  CallId: string;
...
declare interface DescribeCallBackStatusResponse {
  /** 错误码 */
  ErrorCode?: string;
  /** 错误信息 */
  Msg?: string;
...
declare interface DescribeCallerDisplayListRequest {
  /** 业务appid */
  BizAppId: string;
}

declare interface DescribeCallerDisplayListResponse {
  /** appid */
  AppId?: string | null;
  /** 主叫显号号码集合，codeList[0...*] 结构体数组，如果业务是主被叫互显，该字段为空 */
  CodeList?: CallBackPhoneCode[] | null;
  /** 错误码 */
  ErrorCode?: string;
  /** 错误原因 */
  Msg?: string | null;
...
declare interface Get400CdrRequest {
  /** 业务appid */
  BizAppId: string;
...
declare interface Get400CdrResponse {
  /** 错误码 */
  ErrorCode?: string;
  /** 错误原因 */
  Msg?: string | null;
...
declare interface GetVirtualNumRequest {
  /** 业务appid */
  BizAppId: string;
  ...
  /** 主叫发起呼叫状态：1被叫发起呼叫状态：256主叫响铃状态：2被叫响铃状态：512主叫接听状态：4被叫接听状态：1024主叫拒绝接听状态：8被叫拒绝接听状态：2048主叫正常挂机状态：16被叫正常挂机状态：4096主叫呼叫异常：32被叫呼叫异常：8192例如：值为 0：表示所有状态不需要推送值为 4：表示只要推送主叫接听状态值为 16191：表示所有状态都需要推送（上面所有值和） */
  StatusFlag?: string;
...
declare interface GetVirtualNumResponse {
  /** 错误码 */
  ErrorCode?: string;
  /** 绑定 ID，该 ID 全局唯一 */
  BindId?: string | null;
