...
/** 转接智能体配置 */
declare interface TransferToAgentItem {
  /** 转智能体的function calling 名称 */
...
declare interface CreateAICallRequest {
  ...
  LLMType: string;
  /** 模型API密钥，获取鉴权信息方式请参见各模型官网OpenAI协议：GPT，混元，DeepSeek；Azure协议：Azure GPT；Minimax：Minimax */
  APIKey: string;
  /** 模型接口地址OpenAI协议GPT："https://api.openai.com/v1/"混元："https://api.hunyuan.cloud.tencent.com/v1"Deepseek："https://api.deepseek.com/v1"Azure协议"https://{your-resource-name}.openai.azure.com?api-version={api-version}"Minimax协议"https://api.minimax.chat/v1" */
  APIUrl: string;
  ...
  SystemPrompt?: string;
  /** 模型名称，如OpenAI协议"gpt-4o-mini","gpt-4o"，"hunyuan-standard", "hunyuan-turbo"，"deepseek-chat"；Azure协议"gpt-4o-mini", "gpt-4o"；Minmax协议"deepseek-chat". */
  Model?: string;
  ...
  /** 模型是否支持(或者开启)转智能体function calling */
  TransferToAgentEnable?: boolean;
  /** TransferToAgentEnable为true的时候生效: 转智能体配置 */
  TransferToAgentItems?: TransferToAgentItem[];
