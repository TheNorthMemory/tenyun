...
/** 消费组标签 */
declare interface ConsumerLabel {
  /** 标签 */
  Label?: string;
  /** 标签状态枚举值：ACTIVE： 生效中DELETING： 删除中UNKNOWN： 未知 */
  State?: string;
  /** 更新时间单位：毫秒(ms) */
  UpdatedAt?: number;
}
...
/** 路由规则版本 */
declare interface RouteRuleVersion {
  /** 版本号 */
  Version?: number;
  /** 切流时间戳单位：毫秒（ms） */
  CutTimestamp?: number;
...
declare interface CreateConsumerLabelRequest {
  /** 腾讯云 RocketMQ 实例 ID，从 [DescribeFusionInstanceList](https://cloud.tencent.com/document/api/1493/106745) 接口或控制台获得。 */
  InstanceId: string;
  /** 标签 */
  Label: string;
...
declare interface CreateConsumerLabelResponse {
  /** 实例 ID */
  InstanceId?: string;
  /** 消费组 */
  Group?: string;
...
declare interface DeleteConsumerLabelRequest {
  /** 腾讯云 RocketMQ 实例 ID，从 [DescribeFusionInstanceList](https://cloud.tencent.com/document/api/1493/106745) 接口或控制台获得。 */
  InstanceId: string;
  /** 消费组 */
  Group: string;
...
declare interface DeleteConsumerLabelResponse {
  /** 唯一请求 ID，每次请求都会返回。 */
  RequestId?: string;
}
...
declare interface DescribeConsumerClientRequest {
  /** 腾讯云 RocketMQ 实例 ID，从 [DescribeFusionInstanceList](https://cloud.tencent.com/document/api/1493/106745) 接口或控制台获得。 */
  InstanceId: string;
  /** 客户端ID，从 DescribeConsumerClientList 接口中的 ConsumerClient 出参中获得。 */
  ClientId: string;
  /** 过滤查询条件列表，请在引用此参数的API说明中了解使用方法。 */
  Filters?: Filter[];
  /** 查询起始位置，默认为0。 */
...
declare interface DescribeConsumerLabelListRequest {
  /** 腾讯云 RocketMQ 实例 ID，从 [DescribeFusionInstanceList](https://cloud.tencent.com/document/api/1493/106745) 接口或控制台获得。 */
  InstanceId: string;
  /** 消费组 */
  Group: string;
...
declare interface DescribeConsumerLabelListResponse {
  /** 查询总数 */
  TotalCount?: number;
  /** 标签列表 */
...
declare interface DescribeConsumerRouteConfigRequest {
  /** 主题名称，从 [DescribeTopicList](https://cloud.tencent.com/document/api/1493/96030) 接口返回的 [TopicItem](https://cloud.tencent.com/document/api/1493/96031) 或控制台获得。 */
  Topic: string;
  /** 腾讯云 RocketMQ 实例 ID，从 [DescribeFusionInstanceList](https://cloud.tencent.com/document/api/1493/106745) 接口或控制台获得。 */
  InstanceId: string;
...
declare interface DescribeConsumerRouteConfigResponse {
  /** 版本号 */
  Version?: number;
  /** 路由规格 */
  Rules?: RouteRule[];
...
declare interface DescribeConsumerRouteVersionListRequest {
  /** 主题名称，从 [DescribeTopicList](https://cloud.tencent.com/document/api/1493/96030) 接口返回的 [TopicItem](https://cloud.tencent.com/document/api/1493/96031) 或控制台获得。 */
  Topic: string;
  /** 腾讯云 RocketMQ 实例 ID，从 [DescribeFusionInstanceList](https://cloud.tencent.com/document/api/1493/106745) 接口或控制台获得。 */
  InstanceId: string;
...
declare interface DescribeConsumerRouteVersionListResponse {
  /** 查询总数 */
  TotalCount?: number;
  /** 版本列表 */
...
declare interface DescribeMessageResponse {
  ...
  /** 5.x 时间轮定时消息状态，仅在查询定时消息（命中 RMQ_SYS_WHEEL_TIMER）时返回。枚举值：PENDING（未到期）、DELIVERED（已到期投递）、RECALLED（已撤回）、NOT_FOUND（消息不存在）、UNSUPPORTED（该消息类型不支持状态查询，如 4.x DelayLevel 延迟消息）。 */
  DelayMessageStatus?: string | null;
  /** 唯一请求 ID，每次请求都会返回。 */
  RequestId?: string;
}
...
declare interface ModifyInstanceRequest {
  ...
  /** 是否开启ACL */
  AclEnabled?: boolean;
  /** 最大可创建主题数，取值范围参考 [DescribeProductSKUs](https://cloud.tencent.com/document/api/1493/107676) 接口中的 [ProductSKU](https://cloud.tencent.com/document/api/1493/96031) 出参：- 最小值和默认值：TopicNumLimit 参数- 最大值：TopicNumUpperLimit 参数 */
  MaxTopicNum?: number;
  /** 免费额度之外的主题个数，免费额度参考 [DescribeProductSKUs](https://cloud.tencent.com/document/api/1493/107676) 接口中的 [ProductSKU](https://cloud.tencent.com/document/api/1493/96031) 出参中的 TopicNumLimit 参数。 */
...
declare interface ModifyRoleRequest {
  /** 腾讯云 RocketMQ 实例 ID，从 [DescribeFusionInstanceList](https://cloud.tencent.com/document/api/1493/106745) 接口或控制台获得。 */
  InstanceId: string;
  /** 角色名称，从 [DescribeRoleList](https://cloud.tencent.com/document/api/1493/98862) 接口中返回的 [RoleItem](https://cloud.tencent.com/document/api/1493/96031) 或控制台获得。 */
  Role: string;
  /** 是否开启消费 */
  PermRead: boolean;
  /** 是否开启生产 */
...
declare interface PutConsumerRouteConfigRequest {
  /** 主题名称，从 [DescribeTopicList](https://cloud.tencent.com/document/api/1493/96030) 接口返回的 [TopicItem](https://cloud.tencent.com/document/api/1493/96031) 或控制台获得。 */
  Topic: string;
  /** 腾讯云 RocketMQ 实例 ID，从 [DescribeFusionInstanceList](https://cloud.tencent.com/document/api/1493/106745) 接口或控制台获得。 */
  InstanceId: string;
...
declare interface PutConsumerRouteConfigResponse {
  /** 实例 ID */
  InstanceId?: string;
  /** 主题 */
  Topic?: string;
...
declare interface Trocket {
  ...
  /** 查询消费组下的客户端连接列表 {@link DescribeConsumerClientListRequest} {@link DescribeConsumerClientListResponse} */
  DescribeConsumerClientList(data: DescribeConsumerClientListRequest, config?: AxiosRequestConfig): AxiosPromise<DescribeConsumerClientListResponse>;
  ...
  /** 查询消费组某个灰度标签详情 {@link DescribeConsumerLabelRequest} {@link DescribeConsumerLabelResponse} */
