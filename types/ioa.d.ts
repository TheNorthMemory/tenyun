...
declare interface DescribeDevicesRequest {
  /** 管理域实例ID，用于CAM管理域权限分配。若企业未进行管理域的划分，可直接传入根域"1"，此时表示针对当前企业的全部设备和账号进行接口CRUD，具体CRUD的影响范围限制于相应接口的入参。 */
  DomainInstanceId?: string;
  /** 过滤条件参数（字段含义请参考接口返回值）Mid, 类型String，支持操作：【eq，like，ilike】，支持排序Name, 类型String，支持操作：【eq，like，ilike】，支持排序Itime, 类型String，支持操作：【eq，like，ilike】，支持排序UserName, 类型String，支持操作：【eq，like，ilike】，支持排序MacAddr, 类型String，支持操作：【eq，like，ilike】，支持排序UserId, 类型String，支持操作：【eq，like，ilike】，支持排序Ip, 类型String，支持操作：【eq，like，ilike】，支持排序Tags，类型String，支持操作：【eq，like，ilike】，支持排序LocalIpList，类型String，支持操作：【eq，like，ilike】，支持排序SerialNum，类型String，支持操作：【eq，like，ilike】，支持排序Version，类型String，支持操作：【eq，like，ilike】，支持排序StrVersion，类型String，支持操作：【eq，like，ilike】，支持排序RtpStatus，类型String，支持操作：【eq，like，ilike】，不支持排序HostName，类型String，支持操作：【eq，like，ilike】，支持排序IoaUserName，类型String，支持操作：【eq，like，ilike】，支持排序GroupName，类型String，支持操作：【eq，like，ilike】，支持排序CriticalVulListCount，类型Int，支持操作：【eq】，不支持排序RiskCount，类型Int，支持操作：【eq】，不支持排序VulVersion，类型String，支持操作：【eq，like，ilike】，不支持排序Virusver，类型String，支持操作：【eq，like，ilike】，不支持排序SysRepver，类型String，支持操作：【eq，like，ilike】，不支持排序BaseBoardSn，类型String，支持操作：【eq，like，ilike】，支持排序Os，类型String，支持操作：【eq，like，ilike】，支持排序ConnActiveTime，类型String，支持操作：【eq，like，ilike】，不支持排序FirewallStatus，类型Int，支持操作：【eq】，不支持排序DomainName，类型String，支持操作：【eq，like，ilike】，支持排序SysRepVersion，类型String，支持操作：【eq，like，ilike】，支持排序VirusVer，类型String，支持操作：【eq，like，ilike】，支持排序Cpu，类型String，支持操作：【eq，like，ilike】，支持排序Memory，类型String，支持操作：【eq，like，ilike】，支持排序HardDiskSize，类型String，支持操作：【eq，like，ilike】，支持排序AccountName，类型String，支持操作：【like.ilike】，支持排序AccountGroupName，类型String，支持操作：【like.ilike】，支持排序分页参数PageNum 从1开始，小于等于0时使用默认参数PageSize 最大值5000，最好不超过100 */
  Condition?: Condition;
