...
declare interface ISPIPv6CidrBlock {
  ...
  /** 网络运营商类型枚举值：BGP： 默认CMCC： 中国移动CTCC： 中国电信CUCC： 中国联通 */
  ISPType?: string;
  /** IPv6网段类型枚举值：GUA： 全球单播地址ULA： 唯一本地地址 */
  AddressType?: string;
}
...
declare interface NetworkInterface {
  ...
  State?: string;
  /** 弹性网卡状态：PENDING：创建中AVAILABLE：可用的ATTACHING：绑定中DETACHING：解绑中DELETING：删除中INUSE：已绑定 */
  ...
  QosLevel?: string;
  /** 指定的IPv6地址列表，单次最多指定10个。与入参Ipv6AddressCount合并计算配额。 */
  Ipv6Addresses?: Ipv6Address[];
  /** 自动分配IPv6地址个数，内网IP地址个数总和不能超过配额数。与入参Ipv6Addresses合并计算配额。取值范围：[1, 10]单位：个 */
...
declare interface Subnet {
  ...
  /** 是否是CDC所属子网。0:否 1:是 */
  IsCdcSubnet?: number;
  /** 协议栈类型枚举值：DualStack： IPv4和IPv6双栈IPv6Only： IPv6单栈 */
  StackType?: string;
}
...
/** 流量镜像采集目标类型 */
declare interface TrafficMirrorTarget {
  /** 流量镜像的接收IP */
  TargetIps?: string[];
...
declare interface TrafficMirrorTargetResourceInfo {
  /** 接收目标的资源Id */
  TargetId: string;
  /** 接收目标的资源名称 */
  TargetName: string;
...
declare interface VpnConnection {
  ...
  /** 标签键值对数组 */
  TagSet?: Tag[];
  /** 协商类型枚举值：active： 主动协商passive： 被动协商flowTrigger： 流量协商 */
...
declare interface AllocateIp6AddressesBandwidthRequest {
  ...
  Ip6Addresses: string[];
  /** 带宽上限，单位Mbps。可调整的带宽上限值参考产品文档中[IPv6 计费限制说明](https://cloud.tencent.com/document/product/1142/38369)。默认值：1Mbps */
  InternetMaxBandwidthOut?: number;
  /** 网络计费模式。IPv6当前支持：TRAFFIC_POSTPAID_BY_HOUR：流量按小时后付费BANDWIDTH_PACKAGE：共享带宽包付费默认值：TRAFFIC_POSTPAID_BY_HOUR */
  InternetChargeType?: string;
...
declare interface AssignIpv6AddressesRequest {
  /** 弹性网卡实例ID，形如：eni-m6dyj72l。可通过DescribeNetworkInterfaces接口获取。 */
  NetworkInterfaceId: string;
  /** 指定的IPv6地址列表，单次最多指定10个。与入参Ipv6AddressCount合并计算配额。与Ipv6AddressCount必填一个。 */
  Ipv6Addresses?: Ipv6Address[];
  /** 自动分配IPv6地址个数，内网IP地址个数总和不能超过配额数。与入参Ipv6Addresses合并计算配额。与Ipv6Addresses必填一个。 */
  Ipv6AddressCount?: number;
...
declare interface AssignPrivateIpAddressesRequest {
  /** 弹性网卡实例ID，例如：eni-m6dyj72l。可通过DescribeNetworkInterfaces接口获取。 */
  NetworkInterfaceId: string;
...
declare interface AssociateAddressRequest {
  /** 标识 EIP 的唯一 ID。可以使用DescribeAddresses接口获取AddressId。EIP 唯一 ID 形如：eip-11112222。 */
  AddressId: string;
  /** 要绑定的实例 ID。实例 ID 形如：ins-11112222、lb-11112222。可通过登录控制台查询，也可通过 DescribeInstances 接口返回值中的InstanceId获取。 */
  InstanceId?: string;
  ...
  PrivateIpAddress?: string;
  /** 指定绑定时是否设置直通。弹性公网 IP 直通请参见 EIP 直通。取值：true、false，默认值为 false。当绑定 CVM 实例、EKS 弹性集群时，可设定此参数为 true。此参数目前处于内测中，如需使用，请提交 工单申请。 */
...
declare interface AssociateNatGatewayAddressRequest {
  ...
  PublicIpAddresses?: string[];
  /** 弹性IP可用区，自动分配弹性IP时传递。其中产品可用区查询接口为[查询产品可用区列表](https://cloud.tencent.com/document/product/1596/77929) */
  Zone?: string;
...
declare interface CheckTrafficMirrorRequest {
  /** 流量镜像所属的vpc */
  VpcId: string;
  /** 流量镜像的实例id */
  TrafficMirrorId?: string;
...
declare interface CheckTrafficMirrorResponse {
  /** 唯一请求 ID，每次请求都会返回。 */
  RequestId?: string;
}
...
declare interface CreateAndAttachNetworkInterfaceRequest {
  /** VPC实例ID。可通过DescribeVpcs接口获取。 */
  VpcId: string;
  /** 弹性网卡名称，最大长度不能超过60个字符。 */
  NetworkInterfaceName: string;
  /** 弹性网卡所在的子网实例ID，例如：subnet-0ap8nwca。可通过DescribeSubnets接口获取。 */
  SubnetId: string;
  /** 云服务器实例ID。可通过DescribeInstances接口获取。 */
  InstanceId: string;
  /** 指定的内网IP信息，单次最多指定10个。 */
  PrivateIpAddresses?: PrivateIpAddressSpecification[];
  ...
  /** IP服务质量等级，和SecondaryPrivateIpAddressCount配合使用，可选值：PT（云金）、AU（云银）、AG(云铜）、DEFAULT（默认）。 */
  QosLevel?: string;
  /** 指定绑定的安全组，例如：['sg-1dd51d']。可通过DescribeSecurityGroups接口获取。 */
  SecurityGroupIds?: string[];
...
declare interface CreateNetworkInterfaceRequest {
  ...
  /** 指定的内网IP信息，单次最多指定10个。 */
  PrivateIpAddresses?: PrivateIpAddressSpecification[];
  /** 新申请的内网IP地址个数，内网IP地址个数总和不能超过配额数。配额数查询：DescribeVpcLimits。 */
  SecondaryPrivateIpAddressCount?: number;
  /** 指定的IPv6地址列表，单次最多指定10个。与入参Ipv6AddressCount合并计算配额。 */
  Ipv6Addresses?: Ipv6Address[];
  /** 自动分配IPv6地址个数，内网IP地址个数总和不能超过配额数。与入参Ipv6Addresses合并计算配额。取值范围：[1, 10]单位：个 */
...
declare interface DeleteSecurityGroupPoliciesRequest {
  /** 安全组实例ID，例如sg-33ocnj9n，可通过DescribeSecurityGroups获取。 */
  SecurityGroupId: string;
  /** 安全组规则集合。一个请求中只能删除单个方向的一条或多条规则。支持指定索引（PolicyIndex） 匹配删除和安全组规则匹配删除两种方式，一个请求中只能使用一种匹配方式。使用安全组规则匹配删除时，需要填写`Action`， `Protocol`， `CidrBlock`， `Port`参数。 */
  SecurityGroupPolicySet: SecurityGroupPolicySet;
}
...
declare interface DescribeAssistantCidrRequest {
  ...
  VpcIds?: string[];
  /** 过滤条件，参数不支持同时指定VpcIds和Filters。当前支持的过滤条件如下：vpc-id - String - （过滤条件）VPC实例ID，形如：vpc-f49l6u0z。（当前仅支持该过滤条件） */
  Filters?: Filter[];
  /** 偏移量，默认为0。 */
  Offset?: number;
  /** 返回数量，默认为20，最大值为100。 */
...
declare interface DescribeIp6AddressesRequest {
  ...
  /** 每次请求的`Filters`的上限为10，`Filter.Values`的上限为100。参数不支持同时指定`AddressIds`和`Filters`。详细的过滤条件如下： address-ip - String - 是否必填：否 - （过滤条件）按照 IPv6 的 IP 地址过滤。可以使用[DescribeIp6Addresses](https://cloud.tencent.com/document/product/215/40089)接口查询address-ip。 network-interface-id - String - 是否必填：否 - （过滤条件）按照弹性网卡的唯一ID过滤。可以使用[DescribeNetworkInterfaces](https://cloud.tencent.com/document/product/215/15817)接口查询network-interface-id。 */
  Filters?: Filter[];
  /** 偏移量，默认为0。关于`Offset`的更进一步介绍请参考 API [简介](https://cloud.tencent.com/document/api/213/11646)中的相关小节。 */
  Offset?: number;
  /** 返回数量，默认为20，最大值为100。关于`Limit`的更进一步介绍请参考 API [简介](https://cloud.tencent.com/document/api/213/11646)中的相关小节。 */
...
declare interface DescribeNatGatewayZonesRequest {
}

declare interface DescribeNatGatewayZonesResponse {
  /** 可售卖可用区信息列表 */
  ZoneSet: NatZoneInfo[];
  /** 唯一请求 ID，每次请求都会返回。 */
  RequestId?: string;
...
declare interface DescribeNatGatewaysRequest {
  ...
  NatGatewayIds?: string[];
  /** 过滤条件，参数不支持同时指定NatGatewayIds和Filters。每次请求的Filters的上限为10，Filter.Values的上限为5。nat-gateway-id - String - （过滤条件）NAT实例ID，形如：`nat-123xx454`。vpc-id - String - （过滤条件）私有网络 唯一ID，形如：`vpc-123xx454`。nat-gateway-name - String - （过滤条件）协议端口模板实例名称，形如：`test_nat`。tag-key - String - （过滤条件）标签键，形如：`test-key`。nat-state - String - （过滤条件）NAT实例当前状态，形如：`AVAILABLE`。 */
  Filters?: Filter[];
  /** 偏移量，默认为0。 */
  Offset?: number;
  /** 返回数量，默认为20，最大值为100。 */
...
declare interface DescribePrivateNatGatewaysRequest {
  /** 私网网关唯一`ID`，形如：`intranat-0g3blj80`。注意：NatGatewayIds和Filters参数互斥，不能同时传入。 */
  NatGatewayIds?: string[];
...
declare interface DescribeReserveIpAddressesRequest {
  /** 内网保留IP唯一ID 列表 */
  ReserveIpIds?: string[];
  /** 过滤条件，参数不支持同时指定ReserveIpIds和Filters。reserve-ip-id - String - （过滤条件）内网保留 IP唯一 ID，形如：rsvip-pvqgv9vi。vpc-id - String - （过滤条件）VPC实例ID，形如：vpc-f49l6u0z。subnet-id - String - （过滤条件）所属子网实例ID，形如：subnet-f49l6u0z。reserve-address-ip - String - （过滤条件）内网保留 IP 地址，形如：192.168.0.10。ip-type - String - （过滤条件）业务类型 ipType，0。name - String - （过滤条件）名称。state - String - （过滤条件）状态，可选值：Bind， UnBind。resource-id - String - （过滤条件）绑定的实例资源，形如：eni-059qmnif。tag-key - String -（过滤条件）按照标签键进行过滤。tag:tag-key - String - （过滤条件）按照标签键值对进行过滤。 tag-key使用具体的标签键进行替换。 */
  Filters?: Filter[];
  /** 偏移量。 */
  Offset?: number;
  /** 请求对象个数。 */
...
declare interface DescribeRouteListRequest {
...
declare interface DescribeVpcEndPointRequest {
  /** 过滤条件。当前支持如下过滤条件： end-point-service-id- String - （过滤条件）终端节点服务ID。可通过[DescribeVpcEndPointService](https://cloud.tencent.com/document/product/215/54678)接口获取。end-point-name - String - （过滤条件）终端节点实例名称。 end-point-id- String - （过滤条件）终端节点实例ID。可通过[DescribeVpcEndPoint](https://cloud.tencent.com/document/product/215/54679) 接口获取。 vpc-id- String - （过滤条件）VPC实例ID。可通过[DescribeVpcs](https://cloud.tencent.com/document/product/1108/43663)接口获取。 */
  Filters?: Filter[];
  /** 偏移量，默认为0。 */
  Offset?: number;
  /** 单页返回数量，默认为20，最大值为100。 */
  Limit?: number;
  /** 终端节点ID列表。可通过[DescribeVpcEndPoint](https://cloud.tencent.com/document/product/215/54679) 获取。 */
  EndPointId?: string[];
...
declare interface DescribeVpcEndPointServiceRequest {
  /** 过滤条件。不支持同时传入参数 EndPointServiceIds and Filters。 service-id - String - （过滤条件）终端节点服务唯一ID。可通过[DescribeVpcEndPointService](https://cloud.tencent.com/document/product/215/54678)接口获取。service-name - String - （过滤条件）终端节点实例名称。service-instance-id - String - （过滤条件）后端服务的唯一ID，比如lb-dehd3e33。CLB可通过[DescribeLoadBalancers](https://cloud.tencent.com/document/product/1108/48459)接口获取；MYSQL可通过[DescribeDBInstances](https://cloud.tencent.com/document/api/240/38568)接口获取；CRS可通过[DescribeInstances](https://cloud.tencent.com/document/product/239/20018)接口获取；GWLB可通过[DescribeGatewayLoadBalancers](https://cloud.tencent.com/document/product/1782/111683)接口获取。service-type - String - （过滤条件）后端PAAS服务类型，CLB（负载均衡），CDB（云数据库 MySQL），CRS（云数据库 Redis），GWLB（网关负载均衡），不填默认查询类型为CLB。 */
  Filters?: Filter[];
  /** 偏移量，默认为0。 */
  Offset?: number;
  /** 单页返回数量，默认为20，最大值为100。 */
...
declare interface DescribeVpcEndPointServiceWhiteListRequest {
  ...
  /** 单页返回数量，默认为20，最大值为100。 */
  Limit?: number;
  /** 过滤条件。 user-uin String - （过滤条件）用户UIN。登录 腾讯云账号中心控制台 获取。 end-point-service-id String - （过滤条件）终端节点服务ID。可通过[DescribeVpcEndPointService](https://cloud.tencent.com/document/product/215/54678)接口获取。 */
  Filters?: Filter[];
}
...
declare interface DisassociateAddressRequest {
  /** 标识 EIP 的唯一 ID。EIP 唯一 ID 形如：eip-11112222。可以使用DescribeAddresses接口获取AddressId。 */
  AddressId: string;
...
declare interface ModifyTrafficMirrorAttributeRequest {
  /** 流量镜像实例ID */
  TrafficMirrorId: string;
  /** 流量镜像实例名称 */
  TrafficMirrorName?: string;
...
declare interface ModifyVpcEndPointServiceAttributeRequest {
  ...
  AutoAcceptFlag?: boolean;
  /** 后端服务的ID，比如lb-p1hiksdg。CLB可通过[DescribeLoadBalancers](https://cloud.tencent.com/document/product/1108/48459)接口获取；MYSQL可通过[DescribeDBInstances](https://cloud.tencent.com/document/api/240/38568)接口获取；CRS可通过[DescribeInstances](https://cloud.tencent.com/document/product/239/20018)接口获取；GWLB可通过[DescribeGatewayLoadBalancers](https://cloud.tencent.com/document/product/1782/111683)接口获取 */
  ServiceInstanceId?: string;
  /** 协议类型，支持 Ipv4，Ipv6，默认 Ipv4。 */
  IpAddressType?: string;
}
...
declare interface RemoveBandwidthPackageResourcesRequest {
  /** 资源唯一ID，当前支持EIP资源和LB资源，形如'eip-xxxx', 'lb-xxxx'。EIP资源列表：可通过[DescribeAddresses](https://cloud.tencent.com/document/product/215/16702)接口获取。高防EIP、Anycast EIP、精品BGP EIP默认不支持从共享带宽包中移除，其中高防EIP和精品BGP IP可以迁移到其他同线路类型的共享带宽包中。LB资源列表：可通过[DescribeLoadBalancers](https://cloud.tencent.com/document/api/214/30685)接口获取。 */
  ResourceIds?: string[];
  /** 带宽包唯一标识ID，形如'bwp-xxxx'，可以使用[DescribeBandwidthPackages](https://cloud.tencent.com/document/product/215/19209)接口查询BandwidthPackageId。 */
  BandwidthPackageId?: string;
  /** 资源类型，可选值：Address：弹性公网IPLoadBalance：负载均衡 */
...
declare interface ResetTrafficMirrorFilterRequest {
  /** 流量镜像实例ID */
  TrafficMirrorId: string;
  /** 流量镜像需要过滤的natgw实例ID */
  NatId?: string;
...
declare interface ResetTrafficMirrorFilterResponse {
  /** 唯一请求 ID，每次请求都会返回。 */
  RequestId?: string;
}

declare interface ResetTrafficMirrorSrcsRequest {
  /** 流量镜像实例ID */
  TrafficMirrorId: string;
  /** 流量镜像采集对象 */
  CollectorSrcs: string[];
...
declare interface ResetTrafficMirrorSrcsResponse {
  /** 唯一请求 ID，每次请求都会返回。 */
  RequestId?: string;
}

declare interface ResetTrafficMirrorTargetRequest {
  /** 流量镜像实例ID */
  TrafficMirrorId: string;
  /** 流量镜像的接收目的信息 */
  CollectorTarget: TrafficMirrorTarget;
...
declare interface ResetTrafficMirrorTargetResponse {
  /** 唯一请求 ID，每次请求都会返回。 */
  RequestId?: string;
}
...
declare interface StartTrafficMirrorRequest {
  /** 流量镜像实例ID */
  TrafficMirrorId: string;
}

declare interface StartTrafficMirrorResponse {
  /** 唯一请求 ID，每次请求都会返回。 */
  RequestId?: string;
}

declare interface StopTrafficMirrorRequest {
  /** 流量镜像实例ID */
  TrafficMirrorId: string;
}

declare interface StopTrafficMirrorResponse {
  /** 唯一请求 ID，每次请求都会返回。 */
  RequestId?: string;
}
...
declare interface UpdateTrafficMirrorAllFilterRequest {
  /** 流量镜像实例ID */
  TrafficMirrorId: string;
  /** 流量镜像采集方向 */
  Direction?: string;
...
declare interface UpdateTrafficMirrorAllFilterResponse {
  /** 唯一请求 ID，每次请求都会返回。 */
  RequestId?: string;
}

declare interface UpdateTrafficMirrorDirectionRequest {
  /** 流量镜像实例ID */
  TrafficMirrorId: string;
  /** 流量镜像采集方向。取值范围：- EGRESS - 出方向采集- INGRESS - 入方向采集- ALL - 出入双向采集- NO-DIRECTION - 不区分采集方向（新模式）。切换为该模式后将不再支持按方向采集，需通过 CreateTrafficMirrorFilterRules 接口创建带方向的过滤规则，过滤规则支持设置优先级和单独编辑。 */
  Direction: string;
}

declare interface UpdateTrafficMirrorDirectionResponse {
  /** 唯一请求 ID，每次请求都会返回。 */
  RequestId?: string;
}
...
declare interface Vpc {
  ...
  CheckTrafficMirror(data: CheckTrafficMirrorRequest, config?: AxiosRequestConfig): AxiosPromise<CheckTrafficMirrorResponse>;
  ...
  /** 查询NAT网关可售卖的可用区信息 {@link DescribeNatGatewayZonesRequest} {@link DescribeNatGatewayZonesResponse} */
  DescribeNatGatewayZones(data?: DescribeNatGatewayZonesRequest, config?: AxiosRequestConfig): AxiosPromise<DescribeNatGatewayZonesResponse>;
  ...
  ResetTrafficMirrorFilter(data: ResetTrafficMirrorFilterRequest, config?: AxiosRequestConfig): AxiosPromise<ResetTrafficMirrorFilterResponse>;
  /** 重置流量镜像采集对象 {@link ResetTrafficMirrorSrcsRequest} {@link ResetTrafficMirrorSrcsResponse} */
  ResetTrafficMirrorSrcs(data: ResetTrafficMirrorSrcsRequest, config?: AxiosRequestConfig): AxiosPromise<ResetTrafficMirrorSrcsResponse>;
  /** 更新流量镜像接收目的信息 {@link ResetTrafficMirrorTargetRequest} {@link ResetTrafficMirrorTargetResponse} */
  ResetTrafficMirrorTarget(data: ResetTrafficMirrorTargetRequest, config?: AxiosRequestConfig): AxiosPromise<ResetTrafficMirrorTargetResponse>;
  ...
  /** 开启流量镜像 {@link StartTrafficMirrorRequest} {@link StartTrafficMirrorResponse} */
  StartTrafficMirror(data: StartTrafficMirrorRequest, config?: AxiosRequestConfig): AxiosPromise<StartTrafficMirrorResponse>;
  /** 关闭流量镜像 {@link StopTrafficMirrorRequest} {@link StopTrafficMirrorResponse} */
  StopTrafficMirror(data: StopTrafficMirrorRequest, config?: AxiosRequestConfig): AxiosPromise<StopTrafficMirrorResponse>;
  ...
  /** 更新流量镜像过滤规则或者采集对象 {@link UpdateTrafficMirrorAllFilterRequest} {@link UpdateTrafficMirrorAllFilterResponse} */
