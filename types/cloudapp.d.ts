...
declare interface License {
  ...
  LicenseMode?: string;
  /** 软件的授权状态。枚举值说明Issued已颁发，等待激活。一般来说，如果软件已经在运行，不会出现该状态。Active授权在有效期内，这是软件运行期间最常见的状态。Expired授权已过期。订阅类的软件授权有有效期，如果服务器时间已晚于有效期，则会进入过期状态。Deactivated授权已失效。用户如果退货软件，则授权会自动失效。 */
