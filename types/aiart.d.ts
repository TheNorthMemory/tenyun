...
declare interface SubmitTextToImageJobRequest {
  ...
  Images?: string[];
  /** 生成图分辨率格式：&quot;${宽}:${高}&quot;，说明：分辨率的设置和输入是否有参考图（image_urls/images参数）有关：一、文生图（无参考图）默认分辨率：1024:1024；尺寸约束：宽、高均在 [512, 2048] 像素范围内，宽高乘积 ≤ 1024:1024 像素。二、图生图（有参考图）尺寸约束：宽、高均在 [512, 2048] 像素范围内，宽高乘积 ≤ 1024:1024 像素。传入尺寸时（输出自适应，不严格遵循传入尺寸）：输入图分辨率分桶与传入尺寸分桶一致时：按输入图长宽比，缩放至接近 1024:1024 面积输出；输入图分辨率分桶与传入尺寸分桶不一致时：从尺寸列表中选取最接近传入尺寸的尺寸输出不传入尺寸时：模型结合提示词与输入图尺寸，从以下 尺寸列表 37 种尺寸中自动选择：2048:512、1984:512、1920:512、1856:512、1792:512、1728:512、1664:512、1600:512、1536:512、1472:576、1408:640、1344:704、1280:768、1216:832、1152:896、1088:960、1024:1024、960:1088、896:1152、832:1216、768:1280、704:1344、640:1408、576:1472、512:1536、512:1600、512:1664、512:1728、512:1792、512:1856、512:1920、512:1984、512:2048、768:1024、720:1280、1024:768、1280:720 */
  Resolution?: string;
