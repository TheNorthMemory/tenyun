...
declare interface ApproverOption {
  ...
  /** 签署人手机号传参模式枚举值：REPLACE： 接受已有认证手机号并替换GIVEN： 以客户入参输入手机号为主VALIDATE： 若与认证手机号不一致则报错默认值：REPLACE会触发手机号传参模式的前提是：签署人是指定了具体身份信息的渠道方签署人不会触发非渠道方签署人在指定签署人姓名，证件号的情况下会触发 */
