...
declare interface AIGWRerankMaxDocumentsConfig {
  /** 是否开启最大文档数限制枚举值：true： 开启最大文档数限制false： 关闭最大文档数限制 */
...
declare interface AIGWSensitiveWordRoute {
  ...
  /** 路由方法枚举值：Weighted： 权重路由ModelName： 按模型名称路由 */
  SelectedTypes?: string[];
  /** 权重路由配置 */
  WeightedConfig?: CloudNativeAPIGatewayLLMModelServiceRouteWeightedStrategy[];
  /** 模型名称路由权重 */
...
declare interface CNAPIGwConsumer {
  ...
  ModifyTime: string;
  /** 消费者优先级枚举值：Low： 低优先级Medium： 中优先级High： 高优先级 */
  Priority?: string;
  /** 描述 */
  ...
  SyncStatus?: string;
  /** 资源类型枚举值：Public： 公共Private： 私有SourceDeleted： 已删除 */
  SourceType?: string;
  /** 同步版本 */
...
declare interface CloudNativeAPIGatewayLLMModelService {
  ...
  /** 模型服务是否发布到广场枚举值：Published： 已发布Unpublished： 未发布 */
  PublishStatus?: string;
  /** 模型服务是否可以发布 */
  CanPublish?: boolean;
  /** 同步状态枚举值：Fail： 失败Success： 成功 */
  SyncStatus?: string;
  /** 资源类型枚举值：Public： 公共Private： 私有SourceDelete： 资源删除 */
  SourceType?: string;
  /** 同步版本 */
  SyncedVersion?: string;
  /** 健康状态枚举值：Error： 异常 */
...
declare interface KongCertificatesPreview {
  ...
  /** ssl平台证书Id */
  CertId?: string;
  /** 证书类型枚举值：SVR： 服务证书CA： CA证书 */
  CertType?: string;
  /** 证书用途枚举值：SERVER： 用作服务端证书CLIENT： 用作客户端证书 */
  CertUsage?: string;
  /** 证书被引用的次数 */
  ReferCount?: number;
}
...
declare interface CreateCloudNativeAPIGatewayConsumerRequest {
  ...
  Name: string;
  /** 消费者优先级，默认medium枚举值：Low： 低优先级Medium： 中优先级High： 高优先级 */
  Priority?: string;
  /** 消费者描述。最长 200 字符。 */
  Description?: string;
}
...
declare interface CreateCloudNativeAPIGatewayLLMModelAPIRequest {
  /** 网关 id。 */
  GatewayId: string;
  /** AI 网关 LLM 模型 API 的唯一标识名称，格式规则：2-50 字符，支持中英文大小写、数字及分隔符（“-”、“_”)，不能以数字和分隔符开头，不能以分隔符结尾。 */
  Name: string;
  /** 选择业务场景, 选项：Chat（聊天）。 */
  SceneType: string;
  /** 业务场景对应的请求协议，选项：OpenAI（目前只支持 OpenAI）。 */
...
declare interface DescribeCloudNativeAPIGatewayConsumerListRequest {
  ...
  /** 起始位置 */
  Offset: number;
  /** 资源类型枚举值：ModelAPI： 模型APIMCPServer： MCP服务 */
  ResourceType?: string;
  /** 资源ID */
  ResourceId?: string;
}
...
declare interface ModifyCloudNativeAPIGatewayConsumerRequest {
  ...
  /** 消费者名称，最长 60 字符。 */
  Name: string;
  /** 优先级，默认Medium枚举值：Low： 低优先级Medium： 中优先级High： 高优先级 */
  Priority?: string;
  /** 消费者描述。最长 200 字符。 */
  Description?: string;
}
...
declare interface ModifyCloudNativeAPIGatewayLLMModelServiceRequest {
  ...
  /** 外部服务来源ID */
  ExternalInstanceId?: string;
  /** 自定义供应商名称仅当Provider值为"custom"时允许填写 */
  CustomProviderName?: string;
  /** 负载均衡配置 */
  LoadBalanceConfig?: AIGWLoadBalanceConfig;
}
